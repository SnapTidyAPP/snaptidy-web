...
Static website for SnapTidy, ready for GitHub Pages.
...
Replace `YOUR_GITHUB_USERNAME` and `YOUR_REPO_NAME` after GitHub Pages is enabled.
...
Support email: `snaptidyapp@outlook.com`
